                ...
                >
                    <Box w='50%'>
                        <Text
                            ...
                            fontSize={isSmallerThan764 ? '2xl' : '3xl'}
                        >
                            Oi, sejam bem-vindas(os)!
                        </Text>
                        <Text fontSize={isSmallerThan764 ? 'sm' : 'lg'}> Meu nome é Angel e sou criadora dessa loja 💅🏽 </Text>
                        <Text fontSize={isSmallerThan764 ? 'sm' : 'lg'}>Peças com 1 ano de garantia sendo atualizadas todo mês</Text>
                        <Text fontSize={isSmallerThan764 ? 'sm' : 'lg'}>
